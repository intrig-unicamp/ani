...
set output "./edge/mod2-mapping-edge.eps"
plot './mod2-data.txt' i 0 using ($1-0.24):8:7:11:10 with candlesticks fs pattern 2 t "Node-Oriented" lt 1 lw 3 lc rgb "green" whiskerbars, \
