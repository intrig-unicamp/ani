...
set output "./node/mod1-mapping-node.eps"
plot './mod1-data.txt' i 0 using ($1-0.24):3:2:6:5 with candlesticks fs pattern 2 t "Node-Oriented" lt 1 lw 3 lc rgb "green" whiskerbars, \
