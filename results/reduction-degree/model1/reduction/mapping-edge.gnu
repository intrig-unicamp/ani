...
set output "./edge/mod1-mapping-edge.eps"
plot './mod1-data.txt' i 0 using ($1-0.24):8:7:11:10 with candlesticks fs pattern 2 t "Node-Oriented" lt 1 lw 3 lc rgb "green" whiskerbars, \
